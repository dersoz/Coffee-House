...
$(document).ready(function () {
    ...
    oReq.open("GET", "https://floating-hamlet-85904.herokuapp.com/kahveci/kahve");
    oReq.send();
});
var drinkList = [];
var totalCost = 0;
...
function purchase() {
    ...
    oReq.open("PUT", "https://floating-hamlet-85904.herokuapp.com/kahveci/purchase");
...
function getReport() {
    ...
    oReq.open("GET", "https://floating-hamlet-85904.herokuapp.com/kahveci/purchase/sales/"+$('#icecekSecRep').val());
    oReq.send();
    return false;
}